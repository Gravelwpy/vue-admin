      ...
      <el-table
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button
              size="mini"
              @click="handleEdit(scope.$index, scope.row)">测试对比图</el-button>
            <el-button
              size="mini"
              type="danger"
  ...
  export default {
    ...
    methods: {
      ...
      handleEdit(index, row) {
        localStorage.setItem('localeditdata', row.locId);
        // console.log(row);
      ...
      getlocallist() {
        ...
        this.locationInfo = JSON.parse(localStorage.getItem('localdata')).test_point;
